...
Процедура УстановитьНачальныеНастройкиУпр(ДополнительныеПараметры = Неопределено)
	...
	|	ИсточникДанных.НазначениеИспользования КАК НазначениеИспользования,
	|	ПРЕДСТАВЛЕНИЕ(ИсточникДанных.НазначениеИспользования),
	...
	|	ПРЕДСТАВЛЕНИЕ(ИсточникДанных.ФизЛицо),
	...
	|	ИсточникДанных.ПогашеннаяСтоимостьНачальныйОстаток КАК ПогашеннаяСтоимостьНачальныйОстаток,
	|	ИсточникДанных.ПогашеннаяСтоимостьПриход КАК ПогашеннаяСтоимостьПриход,
	|	ИсточникДанных.ПогашеннаяСтоимостьРасход КАК ПогашеннаяСтоимостьРасход,
	|	ИсточникДанных.ПогашеннаяСтоимостьКонечныйОстаток КАК ПогашеннаяСтоимостьКонечныйОстаток,
	...
	|	ПогашеннаяСтоимостьНачальныйОстаток,
	|	ПогашеннаяСтоимостьПриход,
	|	ПогашеннаяСтоимостьРасход,
	|	ПогашеннаяСтоимостьКонечныйОстаток,
	|	Регистратор.*,
	|	Период,
	|	ПериодДень,
	|	ПериодНеделя,
	...
	|}
	|ИЗ РегистрНакопления.ПартииМатериаловВЭксплуатации.ОстаткиИОбороты(&ДатаНач, &ДатаКон, Регистратор {&Периодичность},, {
	...
	|	ФизЛицо.* КАК ФизЛицо}) КАК ИсточникДанных
	|//СОЕДИНЕНИЯ
	|{ГДЕ
	|	ИсточникДанных.КоличествоНачальныйОстаток КАК КоличествоНачальныйОстаток,
	|	ИсточникДанных.КоличествоНачальныйОстаток * ИсточникДанных.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент / ИсточникДанных.Номенклатура.ЕдиницаДляОтчетов.Коэффициент КАК КоличествоНачальныйОстатокВЕдиницахДляОтчетов,
	...
	|	СУММА(ПогашеннаяСтоимостьНачальныйОстаток),
	|	СУММА(ПогашеннаяСтоимостьПриход),
	|	СУММА(ПогашеннаяСтоимостьРасход),
	|	СУММА(ПогашеннаяСтоимостьКонечныйОстаток)
	|	//ИТОГИ_СВОЙСТВА
	|	//ИТОГИ_КАТЕГОРИИ
	|ПО
	|	ОБЩИЕ
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьНачальныйОстаток","Погашенная стоимость начальный остаток");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьПриход","Погашенная стоимость приход");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьРасход","Погашенная стоимость расход");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьКонечныйОстаток","Погашенная стоимость конечный остаток");
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("НазначениеИспользования", "Назначение использования");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ФизЛицо", "Физ.лицо");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьНачальныйОстаток","Погашенная стоимость", Истина, "ЧЦ=15; ЧДЦ=2", "НачальныйОстаток", "Начальный остаток");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьПриход","Погашенная стоимость", Истина, "ЧЦ=15; ЧДЦ=2", "Приход", "Приход");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьРасход","Погашенная стоимость", Истина, "ЧЦ=15; ЧДЦ=2", "Расход", "Расход");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьКонечныйОстаток","Погашенная стоимость", Истина, "ЧЦ=15; ЧДЦ=2", "КонечныйОстаток", "Конечный остаток");
	
	// Добавление предопределенных группировок строк отчета.
	// Необходимо вызывать для каждой добавляемой группировки строки.
	// УниверсальныйОтчет.ДобавитьИзмерениеСтроки(<ПутьКДанным>);
	УниверсальныйОтчет.ДобавитьИзмерениеСтроки("ДокументПередачи");
	...
	УниверсальныйОтчет.ДобавитьОтбор("ДокументПередачи");
...
Процедура УстановитьНачальныеНастройкиБух(ДополнительныеПараметры = Неопределено)
	...
	|	//ПСЕВДОНИМЫ_КАТЕГОРИИ
	|}
	|ИЗ РегистрНакопления.ПартииМатериаловВЭксплуатацииБухгалтерскийУчет.ОстаткиИОбороты(&ДатаНач, &ДатаКон, Регистратор {&Периодичность},, {
	|	Номенклатура.* КАК Номенклатура,
...
Процедура УстановитьНачальныеНастройкиНал(ДополнительныеПараметры = Неопределено)
	...
	|	ИсточникДанных.ПогашеннаяСтоимостьПРНачальныйОстаток КАК ПогашеннаяСтоимостьПРНачальныйОстаток,
	|	ИсточникДанных.ПогашеннаяСтоимостьПРПриход КАК ПогашеннаяСтоимостьПРПриход,
	|	ИсточникДанных.ПогашеннаяСтоимостьПРРасход КАК ПогашеннаяСтоимостьПРРасход,
	|	ИсточникДанных.ПогашеннаяСтоимостьПРКонечныйОстаток КАК ПогашеннаяСтоимостьПРКонечныйОстаток,
	|	ИсточникДанных.ПогашеннаяСтоимостьВРНачальныйОстаток КАК ПогашеннаяСтоимостьВРНачальныйОстаток,
	|	ИсточникДанных.ПогашеннаяСтоимостьВРПриход КАК ПогашеннаяСтоимостьВРПриход,
	|	ИсточникДанных.ПогашеннаяСтоимостьВРРасход КАК ПогашеннаяСтоимостьВРРасход,
	|	ИсточникДанных.ПогашеннаяСтоимостьВРКонечныйОстаток КАК ПогашеннаяСтоимостьВРКонечныйОстаток,
	|	ИсточникДанных.Регистратор КАК Регистратор,
	|	ПРЕДСТАВЛЕНИЕ(ИсточникДанных.Регистратор),
	|	ИсточникДанных.Период КАК Период,
	|	НачалоПериода(ИсточникДанных.Период, День) КАК ПериодДень,
	...
	|	ПогашеннаяСтоимостьПРНачальныйОстаток,
	|	ПогашеннаяСтоимостьПРПриход,
	|	ПогашеннаяСтоимостьПРРасход,
	|	ПогашеннаяСтоимостьПРКонечныйОстаток,
	|	ПогашеннаяСтоимостьВРНачальныйОстаток,
	|	ПогашеннаяСтоимостьВРПриход,
	|	ПогашеннаяСтоимостьВРРасход,
	|	ПогашеннаяСтоимостьВРКонечныйОстаток,
	|	Регистратор.*,
	|	Период,
	|	ПериодДень,
	|	ПериодНеделя,
	...
	|	//ПСЕВДОНИМЫ_КАТЕГОРИИ
	|}
	|ИЗ РегистрНакопления.ПартииМатериаловВЭксплуатацииНалоговыйУчет.ОстаткиИОбороты(&ДатаНач, &ДатаКон, Регистратор {&Периодичность},, {
	|	Номенклатура.* КАК Номенклатура,
	|	СчетУчета.* КАК СчетУчета,
	|	Организация.* КАК Организация,
	|	Подразделение.* КАК Подразделение,
	...
	|	СУММА(ПогашеннаяСтоимостьПРНачальныйОстаток),
	|	СУММА(ПогашеннаяСтоимостьПРПриход),
	|	СУММА(ПогашеннаяСтоимостьПРРасход),
	|	СУММА(ПогашеннаяСтоимостьПРКонечныйОстаток),
	|	СУММА(ПогашеннаяСтоимостьВРНачальныйОстаток),
	|	СУММА(ПогашеннаяСтоимостьВРПриход),
	|	СУММА(ПогашеннаяСтоимостьВРРасход),
	|	СУММА(ПогашеннаяСтоимостьВРКонечныйОстаток)
	|	//ИТОГИ_СВОЙСТВА
	|	//ИТОГИ_КАТЕГОРИИ
	|ПО
	|	ОБЩИЕ
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьПРНачальныйОстаток", "Погашенная стоимость ПР начальный остаток");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьВРНачальныйОстаток", "Погашенная стоимость ВР начальный остаток");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьПРПриход","Погашенная стоимость ПР приход");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьВРПриход","Погашенная стоимость ВР приход");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьПРРасход","Погашенная стоимость ПР расход");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьВРРасход","Погашенная стоимость ВР расход");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьПРКонечныйОстаток", "Погашенная стоимость ПР конечный остаток");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПогашеннаяСтоимостьВРКонечныйОстаток", "Погашенная стоимость ВР конечный остаток");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьПРНачальныйОстаток", "Погашенная стоимость ПР", Истина, "ЧЦ=15; ЧДЦ=2", "НачальныйОстаток", "Начальный остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьВРНачальныйОстаток", "Погашенная стоимость ВР", Истина, "ЧЦ=15; ЧДЦ=2", "НачальныйОстаток", "Начальный остаток");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьПРПриход", "Погашенная стоимость ПР", Истина, "ЧЦ=15; ЧДЦ=2", "Приход", "Приход");
	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьВРПриход", "Погашенная стоимость ВР", Истина, "ЧЦ=15; ЧДЦ=2", "Приход", "Приход");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьПРРасход", "Погашенная стоимость ПР", Истина, "ЧЦ=15; ЧДЦ=2", "Расход", "Расход");
	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьВРРасход", "Погашенная стоимость ВР", Истина, "ЧЦ=15; ЧДЦ=2", "Расход", "Расход");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ВременнаяРазницаКонечныйОстаток", "Временная разница", Истина, "ЧЦ=15; ЧДЦ=2", "КонечныйОстаток", "Конечный остаток");
 	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьПРКонечныйОстаток", "Погашенная стоимость ПР", Истина, "ЧЦ=15; ЧДЦ=2", "КонечныйОстаток", "Конечный остаток");
	УниверсальныйОтчет.ДобавитьПоказатель("ПогашеннаяСтоимостьВРКонечныйОстаток", "Погашенная стоимость ВР", Истина, "ЧЦ=15; ЧДЦ=2", "КонечныйОстаток", "Конечный остаток");
