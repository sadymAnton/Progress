...
Форма20050101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159998", '20030425', "46", "ФормаОтчета2005Кв1");
Форма20060401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159998", '20060331', "37", "ФормаОтчета2006Кв2");
Форма20070101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159998", '20070119', "11", "ФормаОтчета2007Кв1");
Форма20090401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159998", '20090413', "92", "ФормаОтчета2009Кв2");

Если НЕ (ИдКонф = "ЗУП" ИЛИ ИдКонф = "ЗБУ" ИЛИ ИдКонф = "БАУ" ИЛИ ИдКонф = "БАУКОРП") Тогда
	Форма20100101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159998", '20091026', "847н", "ФормаОтчета2010Кв1");
КонецЕсли;
...
НоваяФорма.ДатаНачалоДействия = '2006-04-01'; // Действует с отчета за 1 полугодие 2006 г.
...
НоваяФорма.ОписаниеОтчета     = "Утверждена постановлением ФСС РФ от 25.04.2003 № 46 (в ред. от 31.03.2006 г. № 37, от 19.01.2007 № 11, от 13.04.2009 № 92)";
