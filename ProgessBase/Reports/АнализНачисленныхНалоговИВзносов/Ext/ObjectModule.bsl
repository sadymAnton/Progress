...
Процедура ДоработатьКомпоновщикПередВыводом() Экспорт
	...
	ЕстьЛьгота60ПроцентовПоНСиПЗ          = ПрисутствуетПоле("Взносы.Льгота60ПроцентовПоНСиПЗ");
	...
	ТиповыеОтчеты.УстановитьПараметр(КомпоновщикНастроек, "Льгота60ПроцентовПоНСиПЗ",   ЕстьЛьгота60ПроцентовПоНСиПЗ);
