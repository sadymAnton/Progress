...
Процедура СформироватьОтчет(ДокументРезультат, ЕстьОшибки = Неопределено, ВнешниеНаборыДанных = Неопределено) Экспорт
	...
	|			РаботникиОрганизацийСрезПоследних.ГрафикРаботы.AVT_ПроизводственныйКалендарь КАК ГрафикРаботыAVT_ПроизводственныйКалендарь
	|		ИЗ
	|			(ВЫБРАТЬ
	...
	|				ПО ПериодыОтпуска.Сотрудник = РаботникиОрганизацийСрезПоследних.Сотрудник) КАК ОтпускаРаботника
	...
	|				И ОтпускаРаботника.ГрафикРаботыAVT_ПроизводственныйКалендарь = РегламентированныйПроизводственныйКалендарь.AVT_ПроизводственныйКалендарь
	|	
	|	СГРУППИРОВАТЬ ПО
