...
НоваяФорма.ОписаниеОтчета     = "Форма утверждена Письмом ФНС Росии от 27.01.2006 № ММ-6-03/85@ (в ред. письма ФНС России от 31.01.2006 № ММ-6-03/100@)";
НоваяФорма.ДатаНачалоДействия = '20050101';
НоваяФорма.ДатаКонецДействия  = '20051231'; // Ограничим сразу срок действия формы
