...
Функция СформироватьЗаголовок() Экспорт
	...
	Если ВыводитьЕдиницуИзмерения Тогда
		БухгалтерскиеОтчеты.ДобавитьТекстПроЕдиницуИзмерения(ТекстПроСписокРесурсов);
	КонецЕсли;
...
Функция СформироватьСтруктуруДляСохраненияНастроек() Экспорт
	...
	СтруктураНастроек.Вставить("ВыводитьЕдиницуИзмерения", ВыводитьЕдиницуИзмерения);
...
Процедура ВосстановитьНастройкиИзСтруктуры(СтруктураСНастройками) Экспорт
	...
	СтруктураСНастройками.Свойство("ВыводитьЕдиницуИзмерения", ВыводитьЕдиницуИзмерения);
