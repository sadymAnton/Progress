...
Функция СформироватьОтчет(Результат = Неопределено, ДанныеРасшифровки = Неопределено, ВыводВФормуОтчета = Истина) Экспорт
	...
	Если ПараметрПериод = Неопределено Тогда
		ПериодФормирования = ОбщегоНазначенияЗК.ПолучитьРабочуюДату()
	Иначе
	...
	ТДанных.Колонки.Добавить("НомерСтрокиОтчета", ОбщегоНазначенияЗК.ПолучитьОписаниеТиповСтроки(10));
	ТДанных.Колонки.Добавить("Порядок", ОбщегоНазначенияЗК.ПолучитьОписаниеТиповЧисла(2));
	ТДанных.Колонки.Добавить("ИмяСтрокиОтчета", ОбщегоНазначенияЗК.ПолучитьОписаниеТиповСтроки(100));
	...
	ИначеЕсли ГодФормирования < 2016 Тогда
	...
	Иначе
		...
		СКД = ПолучитьМАкет("СхемаКомпоновкиДанных2015");
		
		Категории = Перечисления.КатегорииДолжностейДляУчетаЗабронированныхС2011Года;
		
		ОписаниеСтрокиДанных(ТДанных, "1", 1, "Руководители", Категории.Руководители);
		
		ОписаниеСтрокиДанных(ТДанных, "2", 2, "Специалисты", Категории.СпециалистыСХ);
		ОписаниеСтрокиДанных(ТДанных, "2", 2, "Специалисты", Категории.СпециалистыПолезныеИскопаемые);
		ОписаниеСтрокиДанных(ТДанных, "2", 2, "Специалисты", Категории.СпециалистыПроизводствоЭлектроэнергии);
		ОписаниеСтрокиДанных(ТДанных, "2", 2, "Специалисты", Категории.СпециалистыСтроительство);
		ОписаниеСтрокиДанных(ТДанных, "2", 2, "Специалисты", Категории.СпециалистыТранспорт);
		ОписаниеСтрокиДанных(ТДанных, "2", 2, "Специалисты", Категории.СпециалистыОбразования);
		ОписаниеСтрокиДанных(ТДанных, "2", 2, "Специалисты", Категории.СпециалистыЗдравоохранение);
		ОписаниеСтрокиДанных(ТДанных, "2", 2, "Специалисты", Категории.СпециалистыОбрабатывающиеПроизводства);
		ОписаниеСтрокиДанных(ТДанных, "2", 2, "Специалисты", Категории.ПрочиеСпециалисты);
		
		ОписаниеСтрокиДанных(ТДанных, "3", 3, "Служащие", Категории.ДругиеСлужащие);
		
		ОписаниеСтрокиДанных(ТДанных, "4", 4, "Рабочие", Категории.РабочиеИмеющиеТарифныйРазряд);
		ОписаниеСтрокиДанных(ТДанных, "4", 4, "Рабочие", Категории.РабочиеНеИмеющиеТарифныхРазрядов);
		ОписаниеСтрокиДанных(ТДанных, "4", 4, "Рабочие", Категории.РабочиеСХ);
		ОписаниеСтрокиДанных(ТДанных, "4", 4, "Рабочие", Категории.РабочиеЛокомотивныхБригад);
		ОписаниеСтрокиДанных(ТДанных, "4", 4, "Рабочие", Категории.Водители);
		ОписаниеСтрокиДанных(ТДанных, "4", 4, "Рабочие", Категории.Трактористы);

		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.Руководители);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.СпециалистыСХ);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.СпециалистыПолезныеИскопаемые);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.СпециалистыПроизводствоЭлектроэнергии);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.СпециалистыСтроительство);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.СпециалистыОбразования);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.СпециалистыЗдравоохранение);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.СпециалистыТранспорт);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.СпециалистыОбрабатывающиеПроизводства);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.ПрочиеСпециалисты);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.ДругиеСлужащие);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.РабочиеИмеющиеТарифныйРазряд);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.РабочиеНеИмеющиеТарифныхРазрядов);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.РабочиеСХ);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.РабочиеЛокомотивныхБригад);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.Водители);
		ОписаниеСтрокиДанных(ТДанных, "5", 5, "Всего",	Категории.Трактористы);
