	...
	Для Каждого СвойстваОбъекта Из ДвиженияДокумента Цикл
		...
		Если (ВидРегистра = "Сведений") 
			...
			Если ВидРегистра+"."+СвойстваОбъекта.Имя = "Сведений.СписанныеТовары"
			 ...
			 //+ДС 10.01.14
             ИЛИ ВидРегистра+"."+СвойстваОбъекта.Имя = "Сведений.ДС_РаспределениеЗатратПоПеределамОрганизацийМСФО"
             ИЛИ ВидРегистра+"."+СвойстваОбъекта.Имя = "Сведений.ДС_РаспределениеПродукцииПоПеределамОрганизацийМСФО"
			 //-ДС
			 Тогда
				Продолжить;
			КонецЕсли;
