...
Функция СформироватьЗаголовок() Экспорт
	...
	Если ВыводитьЕдиницуИзмерения Тогда
		БухгалтерскиеОтчеты.ДобавитьТекстПроЕдиницуИзмерения(ЗаголовокОтчета.Параметры.ТекстДополнительнаяИнформация);
	КонецЕсли;
...
// Формирование отчета
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок, ВысотаЗаголовка, ПоказыватьПодписи) Экспорт
