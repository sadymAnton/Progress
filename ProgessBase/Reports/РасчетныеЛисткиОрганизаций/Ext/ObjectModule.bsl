			...
			Для каждого СтрокаФизЛицо из СтрокаПериодаРегистрации.Строки Цикл
				...
				Для Сч = 0 по МаксКолвоСтрок Цикл
					...
					Если Сч <= КолВоСтрокВыплачено тогда
						...
						/////Вадим 01.07.2013 12:00:08
	                    ИначеЕсли ВидРасчетногоЛистка = "Рабочий" и ЗначениеЗаполнено(Выплачено.Строки[Сч].ДатаВедомости) тогда
							СтрокаНачисленияУдержания.НачисленияУдержанияВидУдержания = Выплачено.Строки[Сч].ВидРасчета + " от " + Формат(Выплачено.Строки[Сч].ДатаВедомости, "ДФ=dd.MM.yyyy"); 
						...
						ИначеЕсли СокрЛП(Выплачено.Строки[Сч].ВидРасчета)="" тогда
						    СтрокаНачисленияУдержания.НачисленияУдержанияВидУдержания="Возврат зарплаты";
						Иначе
						...
						/////Вадим 01.07.2013 12:38:26
	                     ИначеЕсли ВидРасчетногоЛистка = "Рабочий" и ЗначениеЗаполнено(Выплачено.Строки[Сч].ДатаВедомости) тогда
							СтрокаНачисленияУдержания.НачисленияУдержанияПериодУдержания =  Формат(Выплачено.Строки[Сч].ДатаВедомости, "ДФ=dd.MM.yyyy"); 
