...
Перем мНарастающимИтогом Экспорт;
Перем мИндексФормыОтчета Экспорт;
Перем мИмяФайлаШаблона Экспорт;
...
////////////////////////////////////////////////////////////////////////////////
// ОПЕРАТОРЫ ОСНОВНОЙ ПРОГРАММЫ МОДУЛЯ ОБЪЕКТА

мТаблицаФормОтчета = ТаблицаФормОтчета();