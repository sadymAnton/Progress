...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	ТекстЗапроса = "
		...
		|	РегЗаказы.АП_НазначениеРезерва КАК НазначениеРезерва,
		//|	ПРЕДСТАВЛЕНИЕ(РегЗаказы.АП_НазначениеРезерва) КАК ПредставлениеНазначениеРезерва,
		...
		|	РегЗаказы.АП_НазначениеРезерва.*,
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "НазначениеРезерва",          "Назначение резерва");
	...
	УниверсальныйОтчет.ДобавитьОтбор("НазначениеРезерва");
