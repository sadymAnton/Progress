...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.ДобавитьПолеРесурс(
		"ВесНетто",
		"КоличествоОборот*Номенклатура.ЕдиницаХраненияОстатков.Коэффициент*Номенклатура.ЕдиницаХраненияОстатков.ПРГ_Нетто",
		"Вес нетто (в кг)");
	
	УниверсальныйОтчет.ДобавитьПолеРесурс(
		"ВесБутто",
		"КоличествоОборот*Номенклатура.ЕдиницаХраненияОстатков.Коэффициент*Номенклатура.ЕдиницаХраненияОстатков.Вес",
		"Вес брутто (в кг)");
	//----m.ionov@a-prof.ru---
