...
Форма20120201 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151099", '20091211', "б/н",  "ФормаОтчета2012Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20100401, "1.3.0", , , , '20101231');
ОпределитьФорматВДеревеФормИФорматов(Форма20100401, "5.01" , , , '2011-01-01');
ОпределитьФорматВДеревеФормИФорматов(Форма20110501, "5.02" , , , '2011-05-01');
...
Форма20120202 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151099", '2009-12-11', "б/н",  "ФормаОтчета2012Кв2");
ОпределитьФорматВДеревеФормИФорматов(Форма20120202, "5.05" , , , '2012-06-01');

Форма20121001 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151099", '2009-12-11', "б/н",  "ФормаОтчета2012Кв3");
ОпределитьФорматВДеревеФормИФорматов(Форма20120202, "5.06" , , , '2012-10-01');
...
НоваяФорма.ДатаКонецДействия  = '20060131';
