...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	|	ВложенныйЗапрос.КоличествоВОбщемРезерве КАК КоличествоВОбщемРезерве,
	|	ВложенныйЗапрос.КоличествоВФиксРезерве КАК КоличествоВФиксРезерве,
	|	ВложенныйЗапрос.КоличествоОстаток - ВложенныйЗапрос.КоличествоВРезерве - ВложенныйЗапрос.КоличествоВФиксРезерве + ВложенныйЗапрос.КоличествоКПолучению КАК КоличествоДоступноДляРезервирования,
	|	ВложенныйЗапрос.КоличествоВОбщемРезерве * ВложенныйЗапрос.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент КАК КоличествоВОбщемРезервеБазовыхЕдиниц,
	|	ВложенныйЗапрос.КоличествоВФиксРезерве * ВложенныйЗапрос.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент КАК КоличествоВФиксРезервеБазовыхЕдиниц,
	|	(ВложенныйЗапрос.КоличествоОстаток - ВложенныйЗапрос.КоличествоВРезерве - ВложенныйЗапрос.КоличествоВФиксРезерве + ВложенныйЗапрос.КоличествоКПолучению) * ВложенныйЗапрос.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент КАК КоличествоДоступноДляРезервированияБазовыхЕдиниц,
	|	ВложенныйЗапрос.КоличествоВОбщемРезерве * ВложенныйЗапрос.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент / ВложенныйЗапрос.Номенклатура.ЕдиницаДляОтчетов.Коэффициент КАК КоличествоВОбщемРезервеЕдиницОтчетов,
	|	ВложенныйЗапрос.КоличествоВФиксРезерве * ВложенныйЗапрос.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент / ВложенныйЗапрос.Номенклатура.ЕдиницаДляОтчетов.Коэффициент КАК КоличествоВФиксРезервеЕдиницОтчетов,
	|	(ВложенныйЗапрос.КоличествоОстаток - ВложенныйЗапрос.КоличествоВРезерве - ВложенныйЗапрос.КоличествоВФиксРезерве + ВложенныйЗапрос.КоличествоКПолучению) * ВложенныйЗапрос.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент / ВложенныйЗапрос.Номенклатура.ЕдиницаДляОтчетов.Коэффициент КАК КоличествоДоступноДляРезервированияЕдиницОтчетов
	|{ВЫБРАТЬ
	|	Склад.*,
	|	Номенклатура.*,
	...
	|	КоличествоВОбщемРезерве,
	|	КоличествоВФиксРезерве,
	|	КоличествоДоступноДляРезервирования,
	|	КоличествоВОбщемРезервеБазовыхЕдиниц,
	|	КоличествоВФиксРезервеБазовыхЕдиниц,
	|	КоличествоДоступноДляРезервированияБазовыхЕдиниц,
	|	КоличествоВОбщемРезервеЕдиницОтчетов,
	|	КоличествоВФиксРезервеЕдиницОтчетов,
	|	КоличествоДоступноДляРезервированияЕдиницОтчетов}
	|ИЗ
	|	(ВЫБРАТЬ
	|		ВложенныйЗапрос.Склад КАК Склад,
	...
	|		СУММА(ВложенныйЗапрос.КоличествоВОбщемРезерве) КАК КоличествоВОбщемРезерве,
	|		СУММА(ВложенныйЗапрос.КоличествоВФиксРезерве) КАК КоличествоВФиксРезерве
	|	{ВЫБРАТЬ
	|		Склад,
	|		Номенклатура,
	|		ХарактеристикаНоменклатуры,
	...
	|			0 КАК КоличествоВОбщемРезерве,
	|			0 КАК КоличествоВФиксРезерве
	|		ИЗ
	...
	|		
	|		ВЫБРАТЬ
	|			ТоварыВРезервеНаСкладахОбщие.Склад,
	|			ТоварыВРезервеНаСкладахОбщие.Номенклатура,
	|			ТоварыВРезервеНаСкладахОбщие.ХарактеристикаНоменклатуры,
	|			ТоварыВРезервеНаСкладахОбщие.СерияНоменклатуры,
	|			ЗНАЧЕНИЕ(Справочник.Качество.Новый),
	|			ТоварыВРезервеНаСкладахОбщие.ДокументРезерва,
	|			0,
	|			0,
	|			0,
	|			0,
	|			0,
	|			ТоварыВРезервеНаСкладахОбщие.КоличествоОстаток,
	|			0
	|		ИЗ
	|			РегистрНакопления.ТоварыВРезервеНаСкладах.Остатки(&ДатаКон, АП_НазначениеРезерва <> ЗНАЧЕНИЕ(Справочник.АП_НазначениеРезервов.ПустаяСсылка) {(Склад).* КАК Склад, (Номенклатура).* КАК Номенклатура, (ХарактеристикаНоменклатуры).* КАК ХарактеристикаНоменклатуры, (СерияНоменклатуры).* КАК СерияНоменклатуры, (ДокументРезерва).* КАК ДокументОснование}) КАК ТоварыВРезервеНаСкладахОбщие
	|		
	|		ОБЪЕДИНИТЬ ВСЕ
	|		
	|		ВЫБРАТЬ
	|			КП_ФиксированныеРезервы.Склад,
	|			КП_ФиксированныеРезервы.Номенклатура,
	|			КП_ФиксированныеРезервы.ХарактеристикаНоменклатуры,
	|			ЗНАЧЕНИЕ(Справочник.СерииНоменклатуры.ПустаяСсылка),
	|			ЗНАЧЕНИЕ(Справочник.Качество.Новый),
	|			НЕОПРЕДЕЛЕНО,
	|			0,
	...
	|			0,
	|			0,
	|			СУММА(КП_ФиксированныеРезервы.Количество)
	|		ИЗ
	|			РегистрСведений.КП_ФиксированныеРезервыПоНазначениюРезервов.СрезПоследних(&ДатаКон, {(Склад).* КАК Склад, (Номенклатура).* КАК Номенклатура, (ХарактеристикаНоменклатуры).* КАК ХарактеристикаНоменклатуры}) КАК КП_ФиксированныеРезервы
	|		
	|		СГРУППИРОВАТЬ ПО
	|			КП_ФиксированныеРезервы.Номенклатура,
	|			КП_ФиксированныеРезервы.Склад,
	|			КП_ФиксированныеРезервы.ХарактеристикаНоменклатуры) КАК ВложенныйЗапрос
	|	
	|	СГРУППИРОВАТЬ ПО
	...
	|	ВложенныйЗапрос.КоличествоВОбщемРезерве,
	|	ВложенныйЗапрос.КоличествоВФиксРезерве,
	|	(ВложенныйЗапрос.КоличествоОстаток - ВложенныйЗапрос.КоличествоВРезерве - ВложенныйЗапрос.КоличествоВФиксРезерве + ВложенныйЗапрос.КоличествоКПолучению) КАК КоличествоДоступноДляРезервирования,
	|	(ВложенныйЗапрос.КоличествоВОбщемРезерве * ВложенныйЗапрос.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент) КАК КоличествоВОбщемРезервеБазовыхЕдиниц,
	|	(ВложенныйЗапрос.КоличествоВФиксРезерве * ВложенныйЗапрос.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент) КАК КоличествоВФиксРезервеБазовыхЕдиниц,
	|	((ВложенныйЗапрос.КоличествоОстаток - ВложенныйЗапрос.КоличествоВРезерве - ВложенныйЗапрос.КоличествоВФиксРезерве + ВложенныйЗапрос.КоличествоКПолучению) * ВложенныйЗапрос.Номенклатура.ЕдиницаХраненияОстатков.Коэффициент) КАК КоличествоДоступноДляРезервированияБазовыхЕдиниц,
	...
	|	СУММА(КоличествоВОбщемРезерве),
	|	СУММА(КоличествоВФиксРезерве),
	|	СУММА(КоличествоДоступноДляРезервирования),
	|	СУММА(КоличествоВОбщемРезервеБазовыхЕдиниц),
	|	СУММА(КоличествоВФиксРезервеБазовыхЕдиниц),
	|	СУММА(КоличествоДоступноДляРезервированияБазовыхЕдиниц),
	|	СУММА(КоличествоВОбщемРезервеЕдиницОтчетов),
	|	СУММА(КоличествоВФиксРезервеЕдиницОтчетов),
	|	СУММА(КоличествоДоступноДляРезервированияЕдиницОтчетов)
	|ПО
	|	ОБЩИЕ
	|{ИТОГИ ПО
	|	Склад.*,
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоВОбщемРезерве", "Общий резерв (в ед. хранения)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоВФиксРезерве", "Фикс. резерв (в ед. хранения)");
	//конец изменений 
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоДоступноДляРезервирования", "Доступно к резерв-ю (в ед. хранения)");
	//конец изменений 
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоВОбщемРезервеБазовыхЕдиниц", "Общий резерв (в базовых ед.)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоВФиксРезервеБазовыхЕдиниц", "Фикс. резерв (в базовых ед.)");
	//конец изменений 
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоДоступноДляРезервированияБазовыхЕдиниц", "Доступно к резерв-ю (в базовых ед.)");
	//конец изменений 
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоВОбщемРезервеЕдиницОтчетов", "Общий резерв (в ед. отчетов)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоВФиксРезервеЕдиницОтчетов", "Фикс. резерв (в ед. отчетов)");
	//конец изменений 
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоДоступноДляРезервированияЕдиницОтчетов", "Доступно к резерв-ю  (в ед. отчетов)");
	//конец изменений 
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоВОбщемРезерве", "В ед. хранения", Истина, "ЧЦ=15; ЧДЦ=3", "ОбщийРезерв", "Общий резерв");
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоВФиксРезерве", "В ед. хранения", Истина, "ЧЦ=15; ЧДЦ=3", "ФиксРезерв", "Фикс. резерв");
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоДоступноДляРезервирования", "В ед. хранения", Истина, "ЧЦ=15; ЧДЦ=3", "ДоступноКРезерву", "Доступно к резерв-ю");
	//конец изменений 
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоВОбщемРезервеБазовыхЕдиниц", "В базовых ед.", Ложь, "ЧЦ=15; ЧДЦ=3", "ОбщийРезерв", "Общий резерв");
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоВФиксРезервеБазовыхЕдиниц", "В базовых ед.", Ложь, "ЧЦ=15; ЧДЦ=3", "ФиксРезерв", "Фикс. резерв");
	//конец изменений 
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоДоступноДляРезервированияБазовыхЕдиниц", "В базовых ед.", Ложь, "ЧЦ=15; ЧДЦ=3", "ДоступноКРезерву", "Доступно к резерв-ю");
	//конец изменений 
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоВОбщемРезервеЕдиницОтчетов", "В ед. отчетов", Ложь, "ЧЦ=15; ЧДЦ=3", "ОбщийРезерв", "Общий резерв");
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоВФиксРезервеЕдиницОтчетов", "В ед. отчетов", Ложь, "ЧЦ=15; ЧДЦ=3", "ФиксРезерв", "Фикс. резерв");
	//конец изменений 
	...
	//начало изменений Ожиганов 15.04.2015 информация по общим резервам 
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоДоступноДляРезервированияЕдиницОтчетов", "В ед. отчетов", Ложь, "ЧЦ=15; ЧДЦ=3", "ДоступноКРезерву", "Доступно к резерв-ю");
	//конец изменений 
