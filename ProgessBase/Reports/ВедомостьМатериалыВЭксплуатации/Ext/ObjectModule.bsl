...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	ТекстЗапроса = 
		...
		|	ПРЕДСТАВЛЕНИЕ(РегМатериалы.НазначениеИспользования),
		|	ПРЕДСТАВЛЕНИЕ(РегМатериалы.ДокументПередачи),
		|	РегМатериалы.НазначениеИспользования,
		|	РегМатериалы.ДокументПередачи
		|{ВЫБРАТЬ
		|	Подразделение.*,
		|	Номенклатура.*,
