...
Функция ПолучитьПараметрыИсполненияОтчета() Экспорт
	СтруктураНаcтроек = Новый Структура("ДополнительныеНастройкиОтчета, ИспользоватьСобытияПриФормированииОтчета,
	...
	УправлениеОтчетамиПереопределяемый.НастроитьДоступностьВариантовОтчетаПоЗаявкамКандидатов(СхемаКомпоновкиДанных, СтруктураНаcтроек); 
...
УправлениеОтчетамиПереопределяемый.НастроитьТипИДоступностьПолейОтчетаПоЗаявкамКандидатов(СхемаКомпоновкиДанных);
