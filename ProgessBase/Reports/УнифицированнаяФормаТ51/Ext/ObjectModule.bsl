...
Функция СформироватьЗапрос(СписокФизЛиц, СписокОрганизаций, СписокГоловныхОрганизаций, НачалоПериода, КонецПериода)
	...
	ТекстЗапроса = УправлениеОтчетамиЗК.СформироватьСписокМесяцев(ТекстЗапроса, НачалоПериода, КонецПериода);
		...
		Пока ВыборкаПоОрганизациям.Следующий() Цикл
			...
			Пока ВыборкаПоФЛ.Следующий() Цикл
				...
				Если ВыборкаПоФЛ.ФИО = NULL Тогда
					ОбластьСтрока.Параметры.ФизЛицо = ОбщегоНазначенияЗК.ФамилияИнициалыФизЛица(ВыборкаПоФЛ.ФизЛицоНаименование);
				Иначе
