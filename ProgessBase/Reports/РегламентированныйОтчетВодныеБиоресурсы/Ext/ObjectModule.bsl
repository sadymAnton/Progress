...
Форма20040701 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1110005", '20040615', "САЭ-3-21/368@", "ФормаОтчета2004Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20040701, "3.00000");

Форма20060401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1110011", '20060226', "САЭ-3-21/110@", "ФормаОтчета2006Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20060401, "3.00001");

Форма20100901 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1110011", '20100707', "ММВ-7-3/321", "ФормаОтчета2010Кв4");
...
НоваяФорма.ДатаНачалоДействия = '20060301';
