...
Функция ПечатьТ53(ДокументОбъект) Экспорт
	...
	Пока ВыборкаРаботники.Следующий() Цикл
		...
		// Администратор 13.03.2012 15:16 
		// ОПИСАНИЕ: Выводить в колонку Фамилия, инициалы ФИО полностью
		ОбластьМакетаСтрока.Параметры.ФизЛицо = ВыборкаРаботники.Авт_ФИО;     
		// Администратор 13.03.2012 15:16  
		////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}
...
Функция СформироватьЗапросДляПечати(ДокументОбъект, Режим)
	...
	ИначеЕсли Режим = "ПоТабличнойЧастиДокумента" Тогда
		...
		///////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
		// Администратор 13.03.2012 15:11 
		// ОПИСАНИЕ: Добавляем поле ФИО полностью, для вывода ФИО в Т-53
		|	ЕСТЬNULL(ФИОФизЛицСрезПоследних.Фамилия + "" "" + ФИОФизЛицСрезПоследних.Имя + "" "" + ФИОФизЛицСрезПоследних.Отчество, ЗарплатаКВыплатеОрганизацийЗарплата.ФизлицоНаименование) КАК Авт_ФИО,    
		// Администратор 13.03.2012 15:11  
		////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}
		|	ЗарплатаКВыплатеОрганизацийЗарплата.Сумма + ЗарплатаКВыплатеОрганизацийЗарплата.КомпенсацияЗаЗадержкуЗарплаты КАК Сумма,
		|	ВЫБОР
...
Функция СформироватьЗапросТ49(ДокументОбъект)
	...
	ТекстЗапроса = 
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 05.07.2011 15:17 
	"ВЫБРАТЬ
	...
	|	ОсновныеНачисленияРаботниковОрганизации.ОтработаноДней,
	|	ОсновныеНачисленияРаботниковОрганизации.ОтработаноЧасов,
	|	ОсновныеНачисленияРаботниковОрганизации.ПериодДействияНачало
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ПоследнееКадрИзменение.ФизЛицо,
	|	ПоследнееКадрИзменение.Результат,
	|	ПоследнееКадрИзменение.ВидРасчета,
	|	ПоследнееКадрИзменение.ОтработаноДней,
	|	ПоследнееКадрИзменение.ОтработаноЧасов,
	...
	|ИЗ
	|	(ВЫБРАТЬ
	|		ВТОсновныеНачисления.ФизЛицо КАК ФизЛицо,
	...
	|		ВТОсновныеНачисления.ОтработаноЧасов КАК ОтработаноЧасов,
	...
	|	
	|	СГРУППИРОВАТЬ ПО
	|		ВТОсновныеНачисления.ФизЛицо,
	|		ВТОсновныеНачисления.ВидРасчета,
	|		ВТОсновныеНачисления.Организация,
	|		ВТОсновныеНачисления.Сотрудник,
	|		ВТОсновныеНачисления.Результат,
	|		ВТОсновныеНачисления.ОтработаноДней,
	|		ВТОсновныеНачисления.ОтработаноЧасов,
	|		ВТОсновныеНачисления.ПериодДействияНачало) КАК ПоследнееКадрИзменение
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.РаботникиОрганизаций КАК РаботникиОрганизаций
	...
	|ПОМЕСТИТЬ Данные
	|ИЗ
	  // ЗАКОММЕНТИРОВАНО: Измайлова Полина 05.07.2011 15:32  
	//|	РегистрРасчета.ОсновныеНачисленияРаботниковОрганизаций КАК ОсновныеНачисленияРаботниковОрганизации
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 05.07.2011 15:32 
	|	ВТОснНачисленияСКалендарем КАК ОсновныеНачисленияРаботниковОрганизации
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}  
	|		ЛЕВОЕ СОЕДИНЕНИЕ (ВЫБРАТЬ
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 27.06.2011 16:34 
	...
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 27.06.2011 16:36 
	|			И ОсновныеНачисленияРаботниковОрганизации.Календарь = ПраздничныеДниКалендаря.Календарь
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}
	// ЗАКОММЕНТИРОВАНО: Измайлова Полина 05.07.2011 15:33  
	//|ГДЕ
	//|	ОсновныеНачисленияРаботниковОрганизации.ПериодРегистрации = &Период
	//|	И ОсновныеНачисленияРаботниковОрганизации.Сотрудник В
	//|			(ВЫБРАТЬ
