...
//
Процедура ЗаполнитьЗначениеРеквизитаВДереве(Дерево, Реквизит, Значение) Экспорт
	
	СтрокаДерева = Дерево.Строки.Найти(Реквизит, "ПолныйПуть", Истина);
	СтрокаДерева.Значение = Значение;
	
	МассивРеквизитов = ФайловыеФункцииКлиентСервер.РазложитьСтрокуПоТочкамИСлэшам(Реквизит);
	...
	Для Каждого СтрокаДанных Из ТаблицаДанных Цикл
		...
		Для Каждого Колонка Из ТаблицаДанных.Колонки Цикл
			Если Колонка.Имя = "ДопДанныеПодписанные" ИЛИ Колонка.Имя = "ДопДанныеНеПодписанные" Тогда
				...
				СтрокаДопДанных = ТекСтрока.Строки.Найти(ТекСтрока.ПолныйПуть + ".ДопДанные", "ПолныйПуть");
...
Функция НазваниеКолонки(ПолныйПуть) Экспорт
	...
	МассивСтрок = ФайловыеФункцииКлиентСервер.РазложитьСтрокуПоТочкамИСлэшам(ПолныйПуть);
...
Функция ДанныеТаблицыДерева(ДеревоДанных, НазваниеТаблицы)
	...
	Для Каждого Строка Из СтрокаТаблицы.Строки Цикл
		...
		Для Каждого СтрокаРеквизита Из Строка.Строки Цикл
			Если СтрокаРеквизита.ПолныйПуть = НазваниеТаблицы + ".НомерСтроки.ДопДанные" Тогда
				СтруктураДопДанных = Новый Структура;
				СтруктураПодписываемыхДопДанных = Новый Структура;
				СтруктураНеПодписываемыхДопДанных = Новый Структура;
				СтрокаПодписываемыхДопДанных = СтрокаРеквизита.Строки[0];
				Для Каждого СтрокаДанных Из СтрокаПодписываемыхДопДанных.Строки Цикл
					СтруктураПодписываемыхДопДанных.Вставить(НазваниеКолонки(СтрокаДанных.ПолныйПуть), СтрокаДанных.Значение);
				КонецЦикла;
				СтрокаНеПодписываемыхДопДанных = СтрокаРеквизита.Строки[1];
				Для Каждого СтрокаДанных Из СтрокаНеПодписываемыхДопДанных.Строки Цикл
					СтруктураНеПодписываемыхДопДанных.Вставить(НазваниеКолонки(СтрокаДанных.ПолныйПуть), СтрокаДанных.Значение);
				КонецЦикла;
				СтруктураДопДанных.Вставить("Подписанные", СтруктураПодписываемыхДопДанных);
				СтруктураДопДанных.Вставить("НеПодписанные", СтруктураНеПодписываемыхДопДанных);
				НовСтрока.ДопДанные = СтруктураДопДанных;
			Иначе
...
Функция СтруктураКолонокТаблицыДерева(Дерево, НазваниеТаблицы)
	...
	Для Каждого Подстрока Из СтрокаДерева.Строки Цикл
		СтруктураВозврата.Вставить(НазваниеКолонки(Подстрока.ПолныйПуть));
	КонецЦикла;
