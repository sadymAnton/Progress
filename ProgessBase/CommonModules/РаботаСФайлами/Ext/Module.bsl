...
Функция ПолучитьСписокЗапрещенныхСимволовВИменахФайлов()
	...
	СписокСимволов.Добавить(">");
	СписокСимволов.Добавить("|");
	СписокСимволов.Добавить(","); // Шевченков, добавил для вложений дока заявки на расход
...
//
Функция УдалитьЗапрещенныеСимволыИмени(Знач ИмяФайла, ЗначениеЗамены = "") Экспорт
	...
	Для Каждого СтрокаЗапретногоСимвола  Из СписокСимволов Цикл
		...
		//{25.07.2016 Островерхий заявка №б/н 
		ИтоговоеИмяФайла = СтрЗаменить(ИтоговоеИмяФайла,  СтрокаЗапретногоСимвола.Значение, ЗначениеЗамены); 
		//25.07.2016 Островерхий} 			
...
// Сохранить файл
//
Процедура СохранитьФайл(СтруктураПараметров, Знач ИмяФайла, Хранилище, СпособПерезаписи = "") Экспорт 
