	...
	Иначе
		...
		Попытка
			Прокси = ОбщегоНазначения.WSПрокси(
				...
				"RequisitesWebServiceEndpointImpl2Service", // ИмяСервиса
				"RequisitesWebServiceEndpointImpl2Port",    // ИмяТочкиПодключения
...
Функция АдресСервиса()
	...
	Возврат "https://api.orgregister.1c.ru/orgregister/v2?wsdl";
