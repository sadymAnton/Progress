...
Функция ОстаткиОтпусков(ТаблицаДанных, ИгнорироватьП28Правил = Ложь) Экспорт
	...
	//начало изменений Ожиганов А. 02.02.2017 пробуем ооптимизировать расчет отпускных
	ТаблицаЗаработанныхДнейОтпусков.Индексы.Добавить("Сотрудник, ВидЕжегодногоОтпуска");
	ТаблицаПравНаЕжегодныйОтпуск.Индексы.Добавить("Сотрудник, ВидЕжегодногоОтпуска");
	//конец изменений
	...
	Для Каждого СтрокаДанных Из ДополненнаяТаблицаДанных Цикл
		...
		Для Каждого СтрокаВидаОтпуска Из ТаблицаВидовОтпускаПоСотруднику Цикл
			...
			Если ЗначениеЗаполнено(СтрокаДанных.ДатаНачалаПериода) И ЗначениеЗаполнено(СтрокаДанных.ДатаОкончанияПериода) И Не ЗначениеЗаполнено(РассчитанныйОстаток.РабочийГодПериодаС) Тогда
				...
				/////Вадим 26.11.2013 11:30:25  бп 
				Если ПлановыйОтпуск.ВидЕжегодногоОтпуска=Справочники.ВидыЕжегодныхОтпусков.ПустаяСсылка() тогда
					ПлановыйОтпуск.ВидЕжегодногоОтпуска=Справочники.ВидыЕжегодныхОтпусков.НайтиПоНаименованию("Основной ежегодный отпуск");
				Конецесли;
				Если ПлановыйОтпуск.КоличествоДнейОтпуска=NULL тогда
					ПлановыйОтпуск.КоличествоДнейОтпуска=(ПлановыйОтпуск.ДатаОкончанияОтпуска-ПлановыйОтпуск.ДатаНачалаОтпуска)/86400;
				Конецесли;	
				////ВадимКонец
...
Процедура СписатьФактическиеОтпускаКадровымиПриказами(Знач Регистратор, Знач Организация) Экспорт
	...
	/////Вадим 26.12.2012 15:03:29
	///////////ебанные графики затроенные	
	//Запрос.Текст =
	//"ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	// Измайлова Полина 06.07.2011 09:59 
	|ВЫБРАТЬ
	|	ДатаПоследКадрИзменения.Сотрудник,
	|	ДатаПоследКадрИзменения.ДатаНачала,
	|	ДатаПоследКадрИзменения.ДатаОкончания,
	|	ДатаПоследКадрИзменения.ВидОсновногоОтпуска,
	|	ДатаПоследКадрИзменения.ДатаНачалаДоп,
	|	ДатаПоследКадрИзменения.ВидДополнительногоОтпуска,
	|	ДатаПоследКадрИзменения.КорректироватьОтпуск,
	|	ДатаПоследКадрИзменения.НоваяДатаОкончания,
	|	ДатаПоследКадрИзменения.РегистраторНачалаОтпуска,
	|	ВЫБОР
	|		КОГДА РаботникиОрганизаций.ПериодЗавершения <= ДатаПоследКадрИзменения.ДатаНачала
	...
	|	КОНЕЦ КАК Календарь
	|ПОМЕСТИТЬ ВТ_ОтпускаСотрудниковСКалендарями
	|ИЗ
	|	(ВЫБРАТЬ
	|		ОтпускаСотрудников.Сотрудник КАК Сотрудник,
	|		ОтпускаСотрудников.ДатаНачала КАК ДатаНачала,
	|		ОтпускаСотрудников.ДатаОкончания КАК ДатаОкончания,
	|		ОтпускаСотрудников.ВидОсновногоОтпуска КАК ВидОсновногоОтпуска,
	|		ОтпускаСотрудников.ДатаНачалаДоп КАК ДатаНачалаДоп,
	|		ОтпускаСотрудников.ВидДополнительногоОтпуска КАК ВидДополнительногоОтпуска,
	|		ОтпускаСотрудников.КорректироватьОтпуск КАК КорректироватьОтпуск,
	|		ОтпускаСотрудников.НоваяДатаОкончания КАК НоваяДатаОкончания,
	|		ОтпускаСотрудников.РегистраторНачалаОтпуска КАК РегистраторНачалаОтпуска,
	|		МАКСИМУМ(РаботникиОрганизаций.Период) КАК Период
	|	ИЗ
	|		ВТ_ОтпускаСотрудников КАК ОтпускаСотрудников
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.РаботникиОрганизаций КАК РаботникиОрганизаций
	|			ПО ОтпускаСотрудников.Сотрудник = РаботникиОрганизаций.Сотрудник
	|				И ОтпускаСотрудников.ДатаНачала >= РаботникиОрганизаций.Период
	|	
	|	СГРУППИРОВАТЬ ПО
	|		ОтпускаСотрудников.Сотрудник,
	|		ОтпускаСотрудников.ДатаНачала,
	|		ОтпускаСотрудников.ДатаОкончания,
	|		ОтпускаСотрудников.ВидОсновногоОтпуска,
	|		ОтпускаСотрудников.ДатаНачалаДоп,
	|		ОтпускаСотрудников.ВидДополнительногоОтпуска,
	|		ОтпускаСотрудников.КорректироватьОтпуск,
	|		ОтпускаСотрудников.НоваяДатаОкончания,
	|		ОтпускаСотрудников.РегистраторНачалаОтпуска) КАК ДатаПоследКадрИзменения
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.РаботникиОрганизаций КАК РаботникиОрганизаций
	|		ПО ДатаПоследКадрИзменения.Сотрудник = РаботникиОрганизаций.Сотрудник
	|			И ДатаПоследКадрИзменения.Период = РаботникиОрганизаций.Период
	|;
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
	|
	|////////////////////////////////////////////////////////////////////////////////
	...
	|		КОНЕЦ) КАК ДнейОтпуска,
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 06.07.2011 10:02 
	|	ОтпускаСотрудников.Календарь,
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
	|	ОтпускаСотрудников.РегистраторНачалаОтпуска
	|ПОМЕСТИТЬ ВТ_КадровыеОтпуска
	|ИЗ
	// ЗАКОММЕНТИРОВАНО: Измайлова Полина 06.07.2011 10:01  
	//|	ВТ_ОтпускаСотрудников КАК ОтпускаСотрудников
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 06.07.2011 10:01 
	|	ВТ_ОтпускаСотрудниковСКалендарями КАК ОтпускаСотрудников
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РегламентированныйПроизводственныйКалендарь КАК ПроизводственныйКалендарь
	|		ПО (ПроизводственныйКалендарь.ДатаКалендаря МЕЖДУ ОтпускаСотрудников.ДатаНачала И ВЫБОР
	|				КОГДА ОтпускаСотрудников.ДатаНачалаДоп = ДАТАВРЕМЯ(1, 1, 1)
	...
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 06.07.2011 10:01 
	|			И ОтпускаСотрудников.Календарь = ПроизводственныйКалендарь.AVT_ПроизводственныйКалендарь
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
	|ГДЕ
	|	(НЕ ОтпускаСотрудников.ВидОсновногоОтпуска.ВидЕжегодногоОтпуска = ЗНАЧЕНИЕ(Справочник.ВидыЕжегодныхОтпусков.ПустаяСсылка))
	|
	...
	|	ОтпускаСотрудников.ВидОсновногоОтпуска.ВидЕжегодногоОтпуска,
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 06.07.2011 10:03 
	|	ОтпускаСотрудников.Календарь,
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
	|	ОтпускаСотрудников.РегистраторНачалаОтпуска,
	|	ВЫБОР
	...
	|		КОНЕЦ),
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 06.07.2011 10:21 
	|	ОтпускаСотрудников.Календарь,
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
	|	ОтпускаСотрудников.РегистраторНачалаОтпуска
	|ИЗ
	// ЗАКОММЕНТИРОВАНО: Измайлова Полина 06.07.2011 10:24  
	//|	ВТ_ОтпускаСотрудников КАК ОтпускаСотрудников
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 06.07.2011 10:24 
	|	ВТ_ОтпускаСотрудниковСКалендарями КАК ОтпускаСотрудников
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РегламентированныйПроизводственныйКалендарь КАК ПроизводственныйКалендарь
	|		ПО (ПроизводственныйКалендарь.ДатаКалендаря МЕЖДУ ОтпускаСотрудников.ДатаНачалаДоп И ОтпускаСотрудников.ДатаОкончания)
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 06.07.2011 10:23 
	|			И ОтпускаСотрудников.Календарь = ПроизводственныйКалендарь.AVT_ПроизводственныйКалендарь
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
	|ГДЕ
	|	(НЕ ОтпускаСотрудников.ВидДополнительногоОтпуска.ВидЕжегодногоОтпуска = ЗНАЧЕНИЕ(Справочник.ВидыЕжегодныхОтпусков.ПустаяСсылка))
	...
	|	ОтпускаСотрудников.ВидДополнительногоОтпуска.ВидЕжегодногоОтпуска,
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 06.07.2011 10:26 
	|	ОтпускаСотрудников.Календарь,
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
	|	ОтпускаСотрудников.РегистраторНачалаОтпуска,
	|	ВЫБОР
	...
	|				ПО (ПроизводственныйКалендарьКорректировка.ДатаКалендаря МЕЖДУ КадровыеОтпуска.ДатаНачала И КадровыеОтпуска.НоваяДатаОкончания)
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 06.07.2011 10:27 
	|					И КадровыеОтпуска.Календарь = ПроизводственныйКалендарьКорректировка.AVT_ПроизводственныйКалендарь
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
	|					И (КадровыеОтпуска.КорректироватьОтпуск)
	|		
	|		СГРУППИРОВАТЬ ПО
...
Функция ИсходныеДанныеДляРасчетаОстатков(ТаблицаДанных, МенеджерВременныхТаблиц)
    ...
    |                                          ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РегламентированныйПроизводственныйКалендарь КАК ПроизводственныйКалендарь
    |                                           ПО РаботникиОрганизацийСрезПоследних.ГрафикРаботы.AVT_ПроизводственныйКалендарь = ПроизводственныйКалендарь.AVT_ПроизводственныйКалендарь
    |                           ПО ТаблицаДанных.Сотрудник = РаботникиОрганизацийСрезПоследних.Сотрудник
	|ГДЕ
    |            ПроизводственныйКалендарь.ДатаКалендаря МЕЖДУ ТаблицаДанных.ДатаНачалаПериода И ТаблицаДанных.ДатаОкончанияПериода
	//ДанилКонец
	|
	|СГРУППИРОВАТЬ ПО
	|	ТаблицаДанных.Сотрудник,
