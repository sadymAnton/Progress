...
Процедура ДополнитьСтруктуруПечатныхФорм(СтруктураПечатныхФорм, СотрудникОбъект) Экспорт
	
	Если Не ЗначениеЗаполнено(СотрудникОбъект.ВидДоговора) Или СотрудникОбъект.ВидДоговора = Перечисления.ВидыДоговоровСФизЛицами.ТрудовойДоговор Тогда
		СтруктураПечатныхФорм.Вставить("ТрудовойДоговор", "Трудовой договор");
		СтруктураПечатныхФорм.Вставить("ТрудовойДоговорДистанционный",	"Трудовой договор при дистанционной работе");
...
Процедура ПечатьДополнительныхПечатныхФорм(ИмяМакета, КоличествоЭкземпляров = 1, НаПринтер = Ложь, СотрудникОбъект) Экспорт
	
	// В этой конфигурации дополнительных действий не предусмотрено

КонецПроцедуры // ПечатьДополнительныхПечатныхФорм
