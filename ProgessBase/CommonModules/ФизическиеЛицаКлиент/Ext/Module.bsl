...
Процедура ОбновитьПредставлениеЭлемента(ИмяОбновляемогоЭлемента, ЭтаФорма, Параметр = Неопределено)
	...
	ИначеЕсли ИмяОбновляемогоЭлемента = "ОсновноеИзображение" Тогда
	    ...
	    ПРГ_Картинка = ПРГ_ДопФункцииКлиентСервер.ПРГ_ПолучитьОсновноеИзображение(ОсновноеИзображение);
		...
		Если ЭтаФорма.мТекущееОсновноеИзображение <> ПРГ_Картинка Тогда
			//начало изменений внешние файлы 
			//ЭтаФорма.мТекущееОсновноеИзображение = ОсновноеИзображение.Хранилище.Получить();
			ЭтаФорма.мТекущееОсновноеИзображение = ПРГ_Картинка;//ПРГ_ДопФункцииКлиентСервер.ПРГ_ПолучитьОсновноеИзображение(ОсновноеИзображение);
...
Процедура ФормаЭлементаПриОткрытии(ЭтаФорма) Экспорт
	...
	ЭтаФорма.мТекущееОсновноеИзображение =  ПРГ_ДопФункцииКлиентСервер.ПРГ_ПолучитьОсновноеИзображение(ЭтотОбъект.ОсновноеИзображение);//.Хранилище.Получить();
	//конец изменений внешние файлы 
	ПоказатьОсновноеИзображение(ЭтаФорма);
...
Процедура ФормаЭлементаОбработкаВыбора(РезультатВыбора, ИсточникВыбора, ЭтаФорма) Экспорт
	...
	ИначеЕсли ТипЗнч(РезультатВыбора) = Тип("СправочникСсылка.ХранилищеДополнительнойИнформации") Тогда
		...
		ЭтаФорма.мТекущееОсновноеИзображение = ПРГ_ДопФункцииКлиентСервер.ПРГ_ПолучитьОсновноеИзображение(ЭтаФорма.ОсновноеИзображение); //.Хранилище.Получить();
		//конец изменений внешние файлы 
		ПоказатьОсновноеИзображение(ЭтаФорма);
