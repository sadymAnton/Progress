...
Функция ПроверитьДублиФизлиц(Ссылка, ЗаписьПаспортныхДанных = Неопределено, ИНН, ПФР, ФИО) Экспорт
	...
	ПроверятьФИО = ЗначениеЗаполнено(ФИО);
	...
	Если ПроверятьФИО Тогда // ФИО проверяем только тогда, когда нет других идентификаторов
...
Функция НайтиБольничныеЛистыПоВходящемуНомеру(БольничныйЛист, ПервичныйЛист) Экспорт
	...
	Возврат СтруктураБольничных;
	
КонецФункции

////////////////////////////////////////////////////////////////////////////////
// ПРОЦЕДУРЫ И ФУНКЦИИ ТИПОВЫХ ОТЧЕТОВ

Процедура УдалитьПользовательскиеНастройки(Ссылка) Экспорт
...
////////////////////////////////////////////////////////////////////////////////
// ПРОЦЕДУРЫ И ФУНКЦИИ МЕХАНИЗМА запрета изменений данных

Процедура УстановитьПараметрГраницыЗапретаИзмененияДанных(ОтменитьЗапрет = Ложь) Экспорт
	
	Если ОтменитьЗапрет Тогда
