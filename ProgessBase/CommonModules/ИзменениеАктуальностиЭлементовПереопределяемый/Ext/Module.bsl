...
КонецПроцедуры // ФормаЭлементаПередОткрытиемДополнительно
...
КонецПроцедуры // ФормаЭлементаПослеЗаписиДополнительно

Процедура ВыполнитьДополнительныеДействияФормыЭлемента(Элемент, Форма)  Экспорт
	
	// В этой конфигурации дополнительных действий не предусмотрено
	
КонецПроцедуры // ВыполнитьДополнительныеДействияФормыЭлемента

Процедура ФормаЭлементаПередЗаписьюДополнительно(Форма, СправочникОбъект, Отказ) Экспорт
	
	// В этой конфигурации дополнительных действий не предусмотрено
	
КонецПроцедуры // ФормаЭлементаПередЗаписьюДополнительно
...
КонецПроцедуры // ФормаСпискаПриОткрытииДополнительно

Процедура ФормаСпискаПриЗакрытииДополнительно(Форма, Список) Экспорт
	
	// В этой конфигурации дополнительных действий не предусмотрено
	
КонецПроцедуры // ФормаСпискаПриЗакрытииДополнительно
...
КонецПроцедуры // ФормаСпискаОформлениеСпискаДополнительно