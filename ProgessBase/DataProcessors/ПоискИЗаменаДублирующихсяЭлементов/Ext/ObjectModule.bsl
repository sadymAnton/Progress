...
Функция НайтиДубли(ИскомыйОбъект,СтруктураПоиска,УсловиеСравненияИЛИ=Истина) Экспорт
	...
	Для каждого КлючИЗначение Из СтруктураПоиска Цикл
		...
		Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
			...
			Если СтепеньСхожести = "=" Тогда
				...
				СтрокаГде = ?(СтрокаГде = "", "",СтрокаГде +" "+?(УсловиеСравненияИЛИ,"или","и")+" ")+"Спр."+ИмяРеквизита +" " +ЗнакСравнения+ " &"+ИмяРеквизита;
