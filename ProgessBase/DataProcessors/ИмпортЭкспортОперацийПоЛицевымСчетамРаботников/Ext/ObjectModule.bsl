...
Функция ДобавитьОткрытиеСчетаСотрудника(Ветка, СтруктураОткрытиеСчетов) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Если НЕ ПустаяСтрока(СтрЗаменить(Выборка.АдресМестаРаботы, Символы.ПС, "")) Тогда
			...
			ДобавитьАдресВДеревоЭкспорта(УзелОС, "АдресМестаРаботы", СтрПолучитьСтроку(АдресМестаРаботы,1), "Российская Федерация",,,
		...
		Если (ФорматФайлаобмена = ФорматФайла3 Или ФорматФайлаобмена = ФорматФайла32 Или ФорматФайлаобмена = ФорматФайла33) И ЗначениеЗаполнено(Выборка.Должность) Тогда
		...
		Если ФорматФайлаобмена = ФорматФайла3 Или ФорматФайлаобмена = ФорматФайла32 Или ФорматФайлаобмена = ФорматФайла33 Тогда
		...
		Если ФорматФайлаобмена = ФорматФайла32 Или ФорматФайлаобмена = ФорматФайла33 Тогда
			...
			Если ЗначениеЗаполнено(Выборка.ДатаВыплатыЗаработнойПлаты) Тогда
				ДобавитьЭлемент(УзелОС, "ДатаВыплатыЗаработнойПлаты", Выборка.ДатаВыплатыЗаработнойПлаты);
			КонецЕсли;
...
Функция ДобавитьСотрудникаВДеревоЭкспорта(лВетка, лНпп, лФамилия, лИмя, лОтчество, лОтделениеБанка, лФилиалОтделенияБанка) Экспорт
	...
	Если НЕ ((ФорматФайлаобмена = ФорматФайла3 Или ФорматФайлаобмена = ФорматФайла32 Или ФорматФайлаобмена = ФорматФайла33) И лОтчество = "") Тогда
