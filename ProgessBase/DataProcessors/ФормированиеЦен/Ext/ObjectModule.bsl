...
Процедура ЗаполнитьПостроительОтчетаПоЦенамНоменклатуры(ВключатьНезаполненные, ЗаполнятьТолькоТекстЗапроса) Экспорт
	...
	Если Не ЗаполнятьТолькоТекстЗапроса Тогда
		...
		Если мСписокНоменклатуры = Неопределено Тогда
			МассивОтбора.Добавить("Номенклатура");
			//{21.07.2015 Островерхий заявка №41138 
			ЭлементОтбора = ПостроительОтчета.Отбор.Добавить("Номенклатура.СтатусСКЮ",, "СтатусСКЮ");
			ЭлементОтбора.ВидСравнения  = ВидСравнения.НеРавно;
			ЭлементОтбора.Значение      = Справочники.ПРГ_СтатусыНоменклатуры.НайтиПоКоду("9");
			ЭлементОтбора.Использование = Истина;
			//21.07.2015 Островерхий}
			//{23.03.2016 Островерхий заявка №50518 
			ЭлементОтбора = ПостроительОтчета.Отбор.Добавить("Номенклатура.НСИ_Брендообъем",, "Брендообъем");
			ЭлементОтбора.ВидСравнения  = ВидСравнения.Равно;
			ЭлементОтбора.Значение      = Справочники.НСИ_Брендообъемы.ПустаяСсылка();
