...
Процедура УстановитьОтборВСпискеПоЭлементуКлиент(СписокЭД, ВидЭлемента, ЗначениеЭлемента)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(
		СписокЭД.Отбор, ВидЭлемента, ЗначениеЭлемента, ВидСравненияКомпоновкиДанных.Равно,,ЗначениеЗаполнено(ЗначениеЭлемента));
...
Функция ПолучитьПрисоединенныеФайлыПакетовЭДНаСервере(Знач ПакетыЭД)
	...
	ПрисоединенныеФайлы = РезультатЗапроса.ВыгрузитьКолонку("Ссылка");
...
&НаСервере
Процедура УстановитьОтборВСпискеПоЭлементу(СписокДанных, ВидЭлемента, ЗначениеЭлемента)
	
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбора(СписокДанных.Отбор,
														 ВидЭлемента,
														 ЗначениеЭлемента,
...
Процедура Отправить(Команда)
	...
	СоотвСоглашенийИСтруктурСертификатов = ЭлектронныеДокументыСлужебныйКлиент.СоотвСоглашенийИСтруктурСертификатовДляАвторизации(, МассивЭД);
...
Процедура СохранитьПакетыЭДНаДиск(Команда)
	...
	ПрисоединенныеФайлы = ПолучитьПрисоединенныеФайлыПакетовЭДНаСервере(Элементы.ВсеПакеты.ВыделенныеСтроки);
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Элемент.ТекущиеДанные <> Неопределено И Элемент.ТекущиеДанные.НашОператор Тогда
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Ответственный = ПользователиСервер.АвторизованныйПользователь();
	УстановитьОтборВСпискеПоЭлементу(Список, "Ответственный", Ответственный);
	
	ОтветственныйИсх = Ответственный;
	УстановитьОтборВСпискеПоЭлементу(СписокИсх, "Ответственный", ОтветственныйИсх);
	
	СтатусНераспакованногоПакета = Перечисления.СтатусыПакетовЭД.КРаспаковке;
	УстановитьОтборВСпискеПоЭлементу(НераспакованныеПакеты, "Статус", СтатусНераспакованногоПакета);
	
	СтатусНеотправленногоПакета = Перечисления.СтатусыПакетовЭД.ПодготовленКОтправке;
	УстановитьОтборВСпискеПоЭлементу(НеотправленныеПакеты, "Статус", СтатусНеотправленногоПакета);
