...
Процедура ЗаписатьИзТаблицыВРегистр(ТаблицаРегистра,ГодЗаписи,ПроизводственныйКалендарь) Экспорт
	...
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 20.06.2011 13:33 
	НаборЗаписей.Отбор.AVT_ПроизводственныйКалендарь.Установить(ПроизводственныйКалендарь);
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
	...
	Иначе
		Для Каждого СтрокаТаблицы ИЗ ТаблицаРегистра Цикл
			...
			///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
			// Измайлова Полина 20.06.2011 14:10 
			НоваяЗаписьРегистра.AVT_ПроизводственныйКалендарь = ПроизводственныйКалендарь;
			////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
			// Установим ресурсы "Пятидневка", "Шестидневка" и "КалендарныеДни"
	...
	/////Вадим 19.11.2012 9:21:36
    Запрос.УстановитьПараметр("AVT_ПроизводственныйКалендарь", ПроизводственныйКалендарь);
	...
	/////Вадим 19.11.2012 9:20:48 дописываем за автоматизацию
 	|	И ГрафикиРаботыПоВидамВремени.ГрафикРаботы.AVT_ПроизводственныйКалендарь = &AVT_ПроизводственныйКалендарь
	|
	|СГРУППИРОВАТЬ ПО
