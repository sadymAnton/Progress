...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	ПолныеПраваДополнительный.ЗаписатьТекущиеКадровыеДанныеСотрудника(Отказ, Замещение, Истина, Отбор.Регистратор.Значение);
...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	ПолныеПраваДополнительный.ЗаписатьТекущиеКадровыеДанныеСотрудника(Отказ, Замещение, Ложь, Отбор.Регистратор.Значение);
