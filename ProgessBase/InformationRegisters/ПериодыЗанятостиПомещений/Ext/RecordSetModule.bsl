...
Процедура ВыполнитьПроверку(ДатаНачала = Неопределено, ДатаОкончания = Неопределено)
	...
	ПроцедурыУправленияПерсоналомДополнительный.ПолучитьОшибкиПериодовЗанятостиПомещения(Регистратор, Истина, мПомещения, СообщенияОбОшибках, ДатаНачала, ДатаОкончания);
