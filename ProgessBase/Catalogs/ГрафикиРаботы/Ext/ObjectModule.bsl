...
Функция ПолучитьСоответствиеПеренесенныхДней(ГодЗаполнения)
	...
	// Измайлова Полина 20.06.2011 15:41 
	НаборЗаписей.Отбор.AVT_ПроизводственныйКалендарь.Установить(AVT_ПроизводственныйКалендарь);
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}   
...
Функция ПолучитьДниВПроизводственномКалендаре(ДатаНачалаИнтервала, ДатаОкончанияИнтервала) Экспорт
	...
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 20.06.2011 15:38 
	Запрос.УстановитьПараметр("Календарь", AVT_ПроизводственныйКалендарь);	
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}    
	Запрос.Текст = 
	"ВЫБРАТЬ
...
Функция ДанныеПроизводственногоКалендаря(НомерМесяца) Экспорт
	...
	Запрос = Новый Запрос;
		...
		///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
		// Измайлова Полина 20.06.2011 16:32 
		Запрос.УстановитьПараметр("Календарь",AVT_ПроизводственныйКалендарь);
		////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
		Запрос.Текст = 
		"ВЫБРАТЬ
		...
		|ГДЕ
		///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
		// Измайлова Полина 20.06.2011 16:31 
		|	РегламентированныйПроизводственныйКалендарь.AVT_ПроизводственныйКалендарь = &Календарь И
		////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
...
Функция ДанныеПроизводственногоКалендаряЗаГод(Год)
	...
	|ГДЕ
	///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 20.06.2011 16:34 
	|	РегламентированныйПроизводственныйКалендарь.AVT_ПроизводственныйКалендарь = &Календарь И
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}     
	...
	Запрос.УстановитьПараметр("Год", Год);
		///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
	// Измайлова Полина 20.06.2011 16:35 
	Запрос.УстановитьПараметр("Календарь", AVT_ПроизводственныйКалендарь);
	////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}  
...
Процедура АвтозаполнениеКалендаря(ДатаНачалаИнтервала, ДатаОкончанияИнтервала, СообщатьОбОшибках = Истина) Экспорт
	...
	Если СообщатьОбОшибках и ДнейВИнтервале <> Календарь.Количество() Тогда
		// ИЗМЕНЕНИЕ: Измайлова Полина 20.06.2011 15:40  
		...
		Сообщить("Проверьте правильность заполнения регламентированного производственного календаря """ + Строка(AVT_ПроизводственныйКалендарь) + """ на " + Формат(Год(ТекущийГод), "ЧГ=5") + " год", СтатусСообщения.Важное);
	КонецЕсли;
...
Процедура ПередЗаписью(Отказ)
	//Изменено Перов Андрей 05.10.2017. Не хватка памити при загрузке в базу МСФО	
...
Процедура ПриЗаписи(Отказ)
	...
	Если НЕ ОбменДанными.Загрузка Тогда
		...
		Запрос.УстановитьПараметр("парамТекущийГрафик", Ссылка);
			///////////////////////////////////////////////////////////////{ООО "Автоматизация-Л" ДОРАБОТКА
		// Измайлова Полина 20.06.2011 16:38 
		Запрос.УстановитьПараметр("Календарь", AVT_ПроизводственныйКалендарь);
		////////////////////////////////////////////////////////////////ООО "Автоматизация-Л" ДОРАБОТКА}                                          
