...
Функция ПодготовитьВременныеТаблицы(АктуальныйПериодРегистрации)
	...
	Иначе
		...
		|	ВзносыПоРаботникам.ПФРСтраховаяОборот + ВзносыПоРаботникам.ПФРПоСуммарномуТарифуОборот КАК ПФРСтраховая_НеЕНВД,
		|	ВзносыПоРаботникам.ПФРНакопительнаяЕНВДОборот КАК ПФРНакопительная_ЕНВД,
		|	ВзносыПоРаботникам.ПФРСтраховаяЕНВДОборот + ВзносыПоРаботникам.ПФРПоСуммарномуТарифуЕНВДОборот КАК ПФРСтраховая_ЕНВД,
