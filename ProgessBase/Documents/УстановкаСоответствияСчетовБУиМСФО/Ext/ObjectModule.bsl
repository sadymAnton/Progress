...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для Каждого ТекСтрокаСоответствиеСчетовБУиМСФО Из СоответствиеСчетовБУиМСФО Цикл
		...
		Движение.ТипРегистратора	   = ТекСтрокаСоответствиеСчетовБУиМСФО.ТипРегистратора;
		// is ЯннуровВФ нач 20140528
		Движение.ис_БезСуммы		   = ТекСтрокаСоответствиеСчетовБУиМСФО.ис_БезСуммы;
		Движение.ис_БезВалютнойСуммы   = ТекСтрокаСоответствиеСчетовБУиМСФО.ис_БезВалютнойСуммы;
		Движение.ис_БезКоличества	   = ТекСтрокаСоответствиеСчетовБУиМСФО.ис_БезКоличества;
		// is ЯннуровВФ кон 20140528
		// is ЯннуровВФ нач 20140710
		Движение.ис_ПереносРегистровЗатрат = ТекСтрокаСоответствиеСчетовБУиМСФО.ис_ПереносРегистровЗатрат;
		// is ЯннуровВФ кон 20140710
	...
	//+ДС 19.12.2013
	Для Каждого ТекИсключениеСчетов Из ИсключениеСчетов Цикл
		Движение						= Движения.ДС_ИсключениеСчетов.Добавить();
		Движение.Период					= Дата;
		Движение.Счет					= ТекИсключениеСчетов.СчетХозрасчетный;
		Движение.ВидДвижения			= ТекИсключениеСчетов.ВидДвижения;
		Движение.Субконто1				= ТекИсключениеСчетов.СубконтоХозр1;
		Движение.Субконто2				= ТекИсключениеСчетов.СубконтоХозр2;
		Движение.Субконто3				= ТекИсключениеСчетов.СубконтоХозр3;
		Движение.Реквизит				= ТекИсключениеСчетов.Реквизит;
		Движение.Значение				= ТекИсключениеСчетов.Значение;
		Движение.Комментарий			= ТекИсключениеСчетов.Комментарий;
		Движение.Учитывается			= ТекИсключениеСчетов.Учитывается;
		Движение.ТипРегистратора		= ТекИсключениеСчетов.ТипРегистратора;
        Движение.РеквизитПредставление	= ТекИсключениеСчетов.РеквизитПредставление;
	КонецЦикла;
	//-ДС
