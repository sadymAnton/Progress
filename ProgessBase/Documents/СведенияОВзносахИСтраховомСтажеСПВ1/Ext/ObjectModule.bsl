...
Функция Печать(ИмяМакета, КоличествоЭкземпляров = 1, НаПринтер = Ложь) Экспорт
	...
	Если ИмяМакета = "ФормаСПВ1" Тогда
		...
		Если Год(ОтчетныйПериод) = 2014 Тогда
			РаботаСДиалогами.ВывестиПредупреждение("С 1 января 2014 года рекомендуется использовать документ ""Сведения о страховом стаже застрахованного лица СПВ-2"".");
		КонецЕсли;
