...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если НЕ РольДоступна(Метаданные.ОсновнаяРоль.Имя) Тогда
		ОбщегоНазначения.СообщитьОбОшибке("Не возможно записать Документ Корректировка заказа покупателя тк он не включен ни в один утвержденный бизнес процесс", Отказ);	
	КонецЕсли;  
