...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Если ТипЗнч(ОбъектКопирования) <> Тип("ДокументОбъект.ОперацияМеждународная") Тогда
		Возврат;
	КонецЕсли;
	...
	ДвиженияБУ = РегистрыБухгалтерии.Международный.ВыбратьПоРегистратору(ОбъектКопирования.Ссылка);
