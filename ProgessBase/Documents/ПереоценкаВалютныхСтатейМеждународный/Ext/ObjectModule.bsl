...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если СуммаРазница <> 0 Тогда
			...
			// is ЯннуровВФ нач 20141028
			Если СрезСведений.Исключить Тогда 
				Продолжить;
			КонецЕсли;
			...
			Если СуммаРазница > 0 Тогда
				...
				Если НЕ ЗначениеЗаполнено(СрезСведений.СчетОтнесенияКурсовыхРазниц) Тогда
					// is ЯннуровВФ нач 20140602 ЗР-0И-001326
					...
					Движение.СчетКт = ПланыСчетов.Международный.ПрочиеВнереализационныеДоходы;
					Движение.СубконтоКт[ПланыВидовХарактеристик.ВидыСубконтоМеждународные.ПрочиеДоходыИРасходы] = СтатьяОтнесенияКурсовыхРазниц;
				...
				Иначе
					...
					Для Ном = 1 по Движение.СчетКт.ВидыСубконто.Количество() Цикл
						//>>180716 Степанов 52764 Движение.СубконтоКт[Движение.СчетКт.ВидыСубконто[Ном-1].ВидСубконто] = СрезСведений["Субконто" + Ном];
						БухгалтерскийУчет.УстановитьСубконто(Движение.СчетКт, Движение.СубконтоКт, Ном, СрезСведений["Субконто" + Ном]);
					КонецЦикла;
				КонецЕсли;
				...
				Для Ном = 1 по Движение.СчетДт.ВидыСубконто.Количество() Цикл
					//>>180716 Степанов 52764 Движение.СубконтоДт[Движение.СчетДт.ВидыСубконто[Ном-1].ВидСубконто] = Выборка["Субконто" + Ном];
					БухгалтерскийУчет.УстановитьСубконто(Движение.СчетДт, Движение.СубконтоДт, Ном, Выборка["Субконто" + Ном]);
				КонецЦикла;
			...
			Иначе
				...
				Если НЕ ЗначениеЗаполнено(СрезСведений.СчетОтнесенияКурсовыхРазниц) Тогда
					...
					Движение.СчетДт = ПланыСчетов.Международный.ПрочиеВнереализационныеРасходы;
					Движение.СубконтоДт[ПланыВидовХарактеристик.ВидыСубконтоМеждународные.ПрочиеДоходыИРасходы] = СтатьяОтнесенияКурсовыхРазниц;
					// is ЯннуровВФ кон 20140602
				Иначе
					Движение.СчетДт = СрезСведений.СчетОтнесенияКурсовыхРазниц;
					Для Ном = 1 по Движение.СчетДт.ВидыСубконто.Количество() Цикл
						//>>180716 Степанов 52764 Движение.СубконтоДт[Движение.СчетДт.ВидыСубконто[Ном-1].ВидСубконто] = СрезСведений["Субконто" + Ном];
						БухгалтерскийУчет.УстановитьСубконто(Движение.СчетДт, Движение.СубконтоДт, Ном, СрезСведений["Субконто" + Ном]);
					КонецЦикла;
				КонецЕсли;
				...
				Для Ном = 1 по Движение.СчетКт.ВидыСубконто.Количество() Цикл
					//>>180716 Степанов 52764 Движение.СубконтоКт[Движение.СчетКт.ВидыСубконто[Ном-1].ВидСубконто] = Выборка["Субконто" + Ном];
					БухгалтерскийУчет.УстановитьСубконто(Движение.СчетКт, Движение.СубконтоКт, Ном, Выборка["Субконто" + Ном]);
				КонецЦикла;
			КонецЕсли;
